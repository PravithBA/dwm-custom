...
static const char col_gray4[] = "#ffc978";
...
static const char scratchpadname[] = "peaclock";
static const char *scratchpadcmd[] = {"alacritty", "-e", scratchpadname, NULL};
